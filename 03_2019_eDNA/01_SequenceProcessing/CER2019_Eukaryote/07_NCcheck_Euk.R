...
#### No.7 CMR-009 Eukaryote: Negative & Positive control check
####

# Load workspace and data
load("06_ReadNSummary_EukOut/06_ReadNSummary_EukOut.RData")

# Set random seeds (for reproduction)
ran_seed <- 8181
set.seed(ran_seed)
output_folder07 <- "07_NCcheck_EukOut"
...
ggsave(sprintf("%s/SequenceReads_STDNCreads.pdf", output_folder07), plot = std_nc_reads, width = 8, height = 8)
