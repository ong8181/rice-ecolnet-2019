...
#### No.1 CMR-009 Eukaryote sequence analysis by DADA2
####
...
dir.create("01_CERrice2019_EukSeqOut")
...
# Load sequence reads
# CMR-009-Eukaryote
path <- "01_SequenceProcessing/seqdata_all/CMR-009-EUK"
...
write.table(seqs_out, "01_CERrice2019_EukSeqOut/EukASV_seqs.fa", col.names = FALSE, row.names = FALSE, quote = FALSE)

save.image("01_CERrice2019_EukSeqOut/01_CERrice2019_EukSeq_AllOut.RData")
...
save(list = ls(all.names = TRUE),
     file = "01_CERrice2019_EukSeqOut/01_CERrice2019_EukSeqOut.RData")
