...
#### No.1 CMR-010 Prokaryote sequence analysis by DADA2
####
...
dir.create("01_CERrice2019_ProkSeqOut")
...
# Load sequence reads
# CMR-010-Prokaryote
path <- "01_SequenceProcessing/seqdata_all/CMR-010-PRO"
...
write.table(seqs_out, "01_CERrice2019_ProkSeqOut/ProkASV_seqs.fa", col.names = FALSE, row.names = FALSE, quote = FALSE)

save.image("01_CERrice2019_ProkSeqOut/01_CERrice2019_ProkSeq_AllOut.RData")
...
save(list = ls(all.names = TRUE),
     file = "01_CERrice2019_ProkSeqOut/01_CERrice2019_ProkSeqOut.RData")
