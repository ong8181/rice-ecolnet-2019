...
#### No.1 CMR-011 Invertebrate sequence analysis by DADA2
####
...
dir.create("01_CERrice2019_InvSeqOut")
...
path <- "01_SequenceProcessing/seqdata_all/CMR-011-INV"
...
write.table(seqs_out, "01_CERrice2019_InvSeqOut/InvASV_seqs.fa", col.names = FALSE, row.names = FALSE, quote = FALSE)

save.image("01_CERrice2019_InvSeqOut/01_CERrice2019_InvSeq_AllOut.RData")
...
save(list = ls(all.names = TRUE),
     file = "01_CERrice2019_InvSeqOut/01_CERrice2019_InvSeqOut.RData")
