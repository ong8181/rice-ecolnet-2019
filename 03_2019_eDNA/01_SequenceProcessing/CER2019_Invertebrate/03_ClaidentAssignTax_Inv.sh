####
#### No.3: Claident assigntax for INV
#### (For AnimalCOI sequences)
####

#----------- Taxa assignment using claident -----------#
# Taxa assignment using claident (after picking ASV by DADA2)
IN_DIR="01_SequenceProcessing/CER2019_Invertebrate/01_CERrice2019_InvSeqOut"
OUT_DIR="01_SequenceProcessing/CER2019_Invertebrate/03_ClaidentAssignTax_InvOut"
ASV_NAME="InvASV"
